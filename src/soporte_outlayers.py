...
class GestionOutliersMultivariados:
    ...
    def explorar_outliers_lof(self, var_dependiente, indice_contaminacion=[0.01, 0.05, 0.1], vecinos=[2, 5, 10], colores={-1: "red", 1: "grey"}):
        """
    ...
    def explorar_outliers_if(self, var_dependiente, indice_contaminacion=[0.01, 0.05, 0.1], estimadores=5, colores={-1: "red", 1: "grey"}):
        """
